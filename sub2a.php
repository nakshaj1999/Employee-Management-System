...
<html lang="en">
  ...
  <body background="sign.png">
      ...
      <nav class="navbar navbar-expand-sm fixed-top navbar-dark ">
        ...
        <div>
          <ul class="navbar-nav"><li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown" data-toggle="dropdown" style="margin-right: 46px;color: white"><?php echo $_SESSION['username']; ?> (Admin)</a>
            <div class="dropdown-menu "style="background-color: rgb(0,0,0); background-color: rgba(10,10,100,0.6); margin-top: 13px;">
    ...
    <center>
      <h1 style="margin-top: 400px;">Welcome to SUB 2</h1>
    </center>
