...
<body background="red">
        ...
        <a href="https://sail.co.in/" target="_blank" class="navbar-brand" style="color: white">
          ...
          <a href="logina.php" class="navbar-brand">
	...
	<div class="login">
		<form name="login" action="forgotpa.php" onsubmit="return validate()" method="post">
			<table cellpadding="25" align="center">
				<tr>
					<td colspan="2" align="center" style="font-size: 30px;">FORGOT PASSWORD</td>
				</tr>
				<tr>
					<td>EMAIL</td>
