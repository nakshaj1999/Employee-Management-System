...
<body background="red">
	    <nav class="navbar navbar-expand-sm fixed-top navbar-dark ">
	        ...
	        <div class="collapse navbar-collapse" id="menu">
	    			...
	    			<li class="nav-item">
	    				<a href="leaveapp.php" class="nav-link" style="color: white;margin-left: 600px;font-size: 15px;">LEAVE APPROVALS</a>

    				</li>		    		
	    			<li class="nav-item">
	    				<a href="leaves.php" class="nav-link" style="color: white;margin-left: 50px;font-size: 15px;">LEAVE STATUS</a>
	...
	<div class="login">
		<form name="login" action="leaveD.php"  method="post">
			<table cellpadding="8" >
				...
				<tr>
					<td>EMAIL</td>
					<td><input type="email" name="email" size="18" class="form-control" class="form-control" style="border-radius: 10px;"></td>
				</tr>
