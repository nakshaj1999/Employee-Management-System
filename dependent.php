	...
	<div class="login">
		<form name="login" action="dependentr.php"  method="post">
			<table cellpadding="3" align="center">
				...
				<tr>
					<td>Father's Name</td>
					<td><input type="text" name="fname" size="40" class="email" style="border-radius: 6px; border: 1px;box-shadow: 0 0 20px 0 black;font-size: 15px;"></td>
				</tr>
				<tr>
					<td>Father's Occupation</td>
					<td><input type="text" name="fooc" size="40" class="email" style="border-radius: 6px; border: 1px;box-shadow: 0 0 20px 0 black;font-size: 15px;"></td>
				</tr>
				<tr>
					<td>Mother's Name</td>
					<td><input type="text" name="mname" class="pass" size="40" style="border-radius: 6px; border: 1px;box-shadow: 0 0 20px 0 black;font-size: 15px;"></td>
				</tr>
				<tr>
					<td>Mother's Occupation</td>
					<td><input type="text" name="mooc" size="40" class="email" style="border-radius: 6px; border: 1px;box-shadow: 0 0 20px 0 black;font-size: 15px;"></td>
				</tr>
				</tr>
