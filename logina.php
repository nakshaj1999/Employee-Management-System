	...
	<div class="login">
		<form name="login" action="validatea.php" onsubmit="return validate()" method="post">
			<table cellpadding="25">
				...
				<tr>
					<td colspan="2" align="center" style="font-size: 30px;">LOGIN ADMIN</td>
				</tr>
				<tr>
					<td>EMAIL</td>
				...
				<tr>
					...
					<td colspan="2" align="center" style="font-size: 15px;"><a href="forgota.php" style="text-decoration: none;">Forgot Password?</a></td>
				</tr>
		</table>
